...
try {
  const KEY_OHM = "force-ohm",
    KEY_OHM_LEFTHANDED = "ohm-lefthanded";
  state.forceOhm = localStorage.getItem(KEY_OHM) === "true" || false;
  state.ohmLeftHanded =
    localStorage.getItem(KEY_OHM_LEFTHANDED) === "true" || false;
  ...
  addMenuItem(
    ...
    {
      title: () =>
        state.forceOhm ? "Close One-Handed Mode" : "One-Handed Mode",
  ...
  addMenuItem(
    ...
    {
      title: () =>
        state.ohmLeftHanded ? "Right-Handed Mode" : "Left-Handed Mode",
